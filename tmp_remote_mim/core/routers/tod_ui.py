                ...
                <section class=\"tod-activity-strip\">
                    <div class=\"tod-activity-head\">
                        <div class=\"tod-activity-copy\">
                            <div class=\"eyebrow\">System Activity Status</div>
                            <strong id=\"todActivityHeadline\">Loading TOD activity...</strong>
                            <div id=\"todActivitySummary\" class=\"tod-activity-summary\">Checking current TOD work status, phase progress, and stall state.</div>
                        </div>
                        <div id=\"todActivityBadge\" class=\"status-chip\" data-tone=\"unknown\">Loading</div>
                    </div>
                    <div class=\"tod-activity-grid\">
                        <article class=\"tod-activity-card\"><div class=\"tod-activity-label\">Current State</div><div id=\"todActivityCurrentState\" class=\"tod-activity-value\">-</div><div id=\"todActivityCurrentMeta\" class=\"tod-activity-meta\">Waiting for current TOD state.</div></article>
                        <article class=\"tod-activity-card\"><div class=\"tod-activity-label\">Active Focus</div><div id=\"todActivityFocus\" class=\"tod-activity-value\">-</div><div id=\"todActivityFocusMeta\" class=\"tod-activity-meta\">Waiting for current task and objective focus.</div></article>
                        <article class=\"tod-activity-card\"><div class=\"tod-activity-label\">Phase Progress</div><div id=\"todActivityPhase\" class=\"tod-activity-value\">-</div><div id=\"todActivityPhaseMeta\" class=\"tod-activity-meta\">Waiting for phase progress telemetry.</div></article>
                        <article class=\"tod-activity-card\"><div class=\"tod-activity-label\">Stall Watch</div><div id=\"todActivityStall\" class=\"tod-activity-value\">-</div><div id=\"todActivityStallMeta\" class=\"tod-activity-meta\">Waiting for stall and freshness evidence.</div></article>
                    </div>
                </section>
