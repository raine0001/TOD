...
try {
    ...
    if (Test-Path -LiteralPath (Join-Path $repoRoot "runtime_remote_training/MIM_PROACTIVE_MOMENTUM_MANAGEMENT_V1.latest.json")) {
        Send-RemoteFileB64 -SessionId $session.SessionId -LocalPath "runtime_remote_training/MIM_PROACTIVE_MOMENTUM_MANAGEMENT_V1.latest.json" -RemotePath "/home/testpilot/mim/runtime/shared/MIM_PROACTIVE_MOMENTUM_MANAGEMENT_V1.latest.json"
    }
