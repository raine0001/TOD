...
try {
  Send-RemoteFileB64 $session.SessionId "runtime_remote_training/remote_scripts/apply_ent_plan_selection_v1.py" "$remoteRoot/scripts/apply_ent_plan_selection_v1.py"
  Send-RemoteFileB64 $session.SessionId "runtime_remote_training/remote_scripts/validate_ent_plan_selection_v1.py" "$remoteRoot/scripts/validate_ent_plan_selection_v1.py"
  ...
  if ($currentHash -eq "f47dfcb52636680d534432ee8a320c0dd67618cfdb4a97a131cc0cca4b6e1b13") {
    (Invoke-RemoteChecked $session.SessionId "cd '$remoteRoot' && .venv/bin/python scripts/apply_ent_plan_selection_v1.py").Output
  } elseif ($currentHash -ne "b5b91c94840f578d5b11fcfcb6ebf3b0fa98554edcdee73a55888e2ffa2a3948") {
  ...
  (Invoke-RemoteChecked $session.SessionId "cd '$remoteRoot' && PYTHONPATH='$remoteRoot' MIM_ROOT='$remoteRoot' .venv/bin/python scripts/validate_ent_plan_selection_v1.py").Output
