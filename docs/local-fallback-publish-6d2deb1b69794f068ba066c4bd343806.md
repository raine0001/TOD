...
TOD can use the local fallback executor for bounded tasks in docs/local-fallback-publish-6d2deb1b69794f068ba066c4bd343806.md when Codex only returns wrapper output or no meaningful execution evidence.
